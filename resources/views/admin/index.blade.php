                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-share-square-o"></i><a href="{{route("users")}}">All Users</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{route("roles")}}">All Roles</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{route("create.role")}}">Create Roles</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('images/'.Auth::user()->img)}}" alt="User Avatar">
                        </a>
